...
const resources = {
  en: {
    translation: {
      ...
      'nav.futureEvents': 'Future Events',
      ...
      'addGift.eventSource': 'Event Source',
      'addGift.manualEntry': 'Manual Entry',
      'addGift.fromUpcomingEvents': 'From Upcoming Events',
      'addGift.selectUpcomingEvent': 'Select Upcoming Event',
      'addGift.eventTypeFromUpcoming': 'Event type filled from selected upcoming event',
      ...
      'analytics.upcomingEvents': 'Upcoming Events',
      'analytics.week': 'Week',
      'analytics.month': 'Month',
      'analytics.noUpcomingEvents': 'No upcoming events in this timeframe',
      'analytics.today': 'Today',
      'analytics.tomorrow': 'Tomorrow',
      'analytics.daysUntil': '{days} days',
      'analytics.pastEvent': 'Past',
      ...
      // Future Events
      'futureEvents.title': 'Future Events',
      'futureEvents.description': 'Manage your upcoming events and reminders',
      'futureEvents.noEvents': 'No future events',
      'futureEvents.noEventsDesc': 'Add future events to keep track of them',
      'futureEvents.addEvent': 'Add Event',
      'futureEvents.editEvent': 'Edit Event',
      'futureEvents.nameLabel': 'Event Name',
      'futureEvents.eventTypeLabel': 'Event Type',
      'futureEvents.eventTypePlaceholder': 'e.g., Wedding, Birthday, Bar Mitzvah',
      'futureEvents.dateLabel': 'Date',
      'futureEvents.notesLabel': 'Notes',
      'futureEvents.notesPlaceholder': 'Add additional notes here...',
      'futureEvents.save': 'Save',
      'futureEvents.cancel': 'Cancel',
      'futureEvents.deleteConfirm': 'Are you sure you want to delete this event?',
      'futureEvents.errorLoad': 'Failed to load events',
      'futureEvents.errorSave': 'Failed to save event',
      'futureEvents.errorDelete': 'Failed to delete event',
      'futureEvents.errorNameRequired': 'Event name is required',
      'futureEvents.errorDateRequired': 'Date is required',
      'futureEvents.past': 'Past',
      ...
      // Home Page
      'home.login': 'Login',
      'home.hero.title': 'Track Your Wedding Gifts with Ease',
      'home.hero.subtitle': 'Organize, manage, and never lose track of your wedding gifts. A simple and elegant solution for modern couples.',
      'home.hero.getStarted': 'Get Started',
      'home.features.title': 'Everything You Need',
      'home.features.subtitle': 'Powerful features designed to make gift tracking effortless',
      'home.features.trackGifts.title': 'Track Gifts',
      'home.features.trackGifts.description': 'Record every gift with details like amount, recipient, date, and event type',
      'home.features.familyManagement.title': 'Family Management',
      'home.features.familyManagement.description': 'Organize gifts by family members and keep track of who gave what',
      'home.features.analytics.title': 'Analytics & Insights',
      'home.features.analytics.description': 'Visualize your gift data with charts and comprehensive analytics',
      'home.features.multiCurrency.title': 'Multi-Currency Support',
      'home.features.multiCurrency.description': 'Track gifts in multiple currencies with automatic conversion',
      'home.features.sharing.title': 'Share & Collaborate',
      'home.features.sharing.description': 'Share your ledger with family members and manage permissions',
      'home.features.secure.title': 'Secure & Private',
      'home.features.secure.description': 'Your data is encrypted and secure. Privacy is our priority',
      'home.pricing.title': 'Simple Pricing',
      'home.pricing.subtitle': 'Start tracking your gifts today, completely free',
      'home.pricing.free.title': 'Free Forever',
      'home.pricing.free.price': 'Free',
      'home.pricing.free.description': 'All features included, no credit card required',
      'home.pricing.free.feature1': 'Unlimited gift tracking',
      'home.pricing.free.feature2': 'Family member management',
      'home.pricing.free.feature3': 'Analytics dashboard',
      'home.pricing.free.feature4': 'Multi-currency support',
      'home.pricing.free.feature5': 'Ledger sharing',
      'home.pricing.free.feature6': 'Data export',
      'home.pricing.free.cta': 'Start Free',
      'home.pricing.forever': 'Forever',
      'home.cta.title': 'Ready to Get Started?',
      'home.cta.subtitle': 'Join thousands of couples who trust WedLedger to manage their wedding gifts',
      'home.cta.button': 'Start Tracking Now',
      'home.stats.users': 'Active Users',
      'home.stats.gifts': 'Gifts Tracked',
      'home.stats.families': 'Happy Families',
      'home.stats.rating': 'Rating',
      'home.socialProof': '{count} couples trust WedLedger',
    },
  },
  he: {
    translation: {
      ...
      'nav.futureEvents': 'אירועים עתידיים',
      ...
      'analytics.upcomingEvents': 'אירועים עתידיים',
      'analytics.week': 'שבוע',
      'analytics.month': 'חודש',
      'analytics.noUpcomingEvents': 'אין אירועים עתידיים בתקופה זו',
      'analytics.today': 'היום',
      'analytics.tomorrow': 'מחר',
      'analytics.daysUntil': 'בעוד {days} ימים',
      'analytics.pastEvent': 'עבר',
      ...
      // Future Events
      'futureEvents.title': 'אירועים עתידיים',
      'futureEvents.description': 'נהל את האירועים העתידיים שלך ותזכורות',
      'futureEvents.noEvents': 'אין אירועים עתידיים',
      'futureEvents.noEventsDesc': 'הוסף אירועים עתידיים כדי לעקוב אחריהם',
      'futureEvents.addEvent': 'הוסף אירוע',
      'futureEvents.editEvent': 'ערוך אירוע',
      'futureEvents.nameLabel': 'שם האירוע',
      'futureEvents.eventTypeLabel': 'סוג אירוע',
      'futureEvents.eventTypePlaceholder': 'לדוגמה: חתונה, יום הולדת, בר מצווה',
      'futureEvents.dateLabel': 'תאריך',
      'futureEvents.notesLabel': 'הערות',
      'futureEvents.notesPlaceholder': 'הוסף הערות נוספות כאן...',
      'futureEvents.save': 'שמור',
      'futureEvents.cancel': 'ביטול',
      'futureEvents.deleteConfirm': 'האם אתה בטוח שברצונך למחוק את האירוע?',
      'futureEvents.errorLoad': 'טעינת האירועים נכשלה',
      'futureEvents.errorSave': 'שמירת האירוע נכשלה',
      'futureEvents.errorDelete': 'מחיקת האירוע נכשלה',
      'futureEvents.errorNameRequired': 'שם האירוע הוא שדה חובה',
      'futureEvents.errorDateRequired': 'תאריך הוא שדה חובה',
      'futureEvents.past': 'עבר',
      ...
      // Home Page
      'home.login': 'התחבר',
      'home.hero.title': 'עקוב אחר מתנות החתונה שלך בקלות',
      'home.hero.subtitle': 'ארגן, נהל ולעולם אל תאבד את המתנות שלך. פתרון פשוט ואלגנטי לזוגות מודרניים.',
      'home.hero.getStarted': 'התחל עכשיו',
      'home.features.title': 'כל מה שאתה צריך',
      'home.features.subtitle': 'תכונות חזקות שנועדו להפוך את מעקב המתנות לקל',
      'home.features.trackGifts.title': 'מעקב מתנות',
      'home.features.trackGifts.description': 'רשום כל מתנה עם פרטים כמו סכום, מקבל, תאריך וסוג אירוע',
      'home.features.familyManagement.title': 'ניהול משפחה',
      'home.features.familyManagement.description': 'ארגן מתנות לפי בני משפחה ועקוב אחר מי נתן מה',
      'home.features.analytics.title': 'ניתוח ותובנות',
      'home.features.analytics.description': 'הצג את נתוני המתנות שלך עם תרשימים וניתוח מקיף',
      'home.features.multiCurrency.title': 'תמיכה במטבעות מרובים',
      'home.features.multiCurrency.description': 'עקוב אחר מתנות במספר מטבעות עם המרה אוטומטית',
      'home.features.sharing.title': 'שיתוף ושיתוף פעולה',
      'home.features.sharing.description': 'שתף את הפנקס שלך עם בני משפחה ונהל הרשאות',
      'home.features.secure.title': 'מאובטח ופרטי',
      'home.features.secure.description': 'הנתונים שלך מוצפנים ומאובטחים. הפרטיות היא העדיפות שלנו',
      'home.pricing.title': 'תמחור פשוט',
      'home.pricing.subtitle': 'התחל לעקוב אחר המתנות שלך היום, לגמרי בחינם',
      'home.pricing.free.title': 'חינם לנצח',
      'home.pricing.free.price': 'חינם',
      'home.pricing.free.description': 'כל התכונות כלולות, אין צורך בכרטיס אשראי',
      'home.pricing.free.feature1': 'מעקב מתנות ללא הגבלה',
      'home.pricing.free.feature2': 'ניהול בני משפחה',
      'home.pricing.free.feature3': 'לוח בקרה לניתוח',
      'home.pricing.free.feature4': 'תמיכה במטבעות מרובים',
      'home.pricing.free.feature5': 'שיתוף פנקס',
      'home.pricing.free.feature6': 'ייצוא נתונים',
      'home.pricing.free.cta': 'התחל בחינם',
      'home.pricing.forever': 'לנצח',
      'home.cta.title': 'מוכן להתחיל?',
      'home.cta.subtitle': 'הצטרף לאלפי זוגות שבוטחים בפנקס חתונה לניהול מתנות החתונה שלהם',
      'home.cta.button': 'התחל לעקוב עכשיו',
      'home.stats.users': 'משתמשים פעילים',
      'home.stats.gifts': 'מתנות נרשמו',
      'home.stats.families': 'משפחות מרוצות',
      'home.stats.rating': 'דירוג',
      'home.socialProof': '{count} זוגות בוטחים בפנקס חתונה',
    },
  },
};
